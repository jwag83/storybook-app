...
const storyTemplates = {
    nature: {
        title: "{childName}'s Nature Adventure",
        themes: {
            patience: {
                mini: {
                    ...
                    interaction: "{character1} and {character2} showed {childName} how to care for the plants properly, teaching them about the importance of teamwork.",
                    ...
                    climax: "With determination and the help of {character1} and {character2}, {childName} protected the garden from the storm, using special covers and supports.",
                    resolution: "After the storm passed, something amazing happened! The garden was safe, and the plants had grown stronger from the challenge.",
        ...
        themes: {
            ...
            teamwork: {
                ...
                long: {
                    ...
                    friendsIntro: "Together with {character1} and {character2}, they formed a special building team. Each person brought unique skills and experiences to the project.",
...
const themeMoralCombos = {
    adventure: {
        morals: ['courage', 'friendship', 'kindness'],
        lengths: ['short', 'medium', 'long']
    },
    nature: {
        morals: ['patience', 'kindness', 'curiosity'],
        lengths: ['short', 'medium', 'long']
    },
    fantasy: {
        morals: ['imagination', 'courage', 'friendship'],
        lengths: ['short', 'medium', 'long']
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (themeSelect && moralSelect) {
        themeSelect.addEventListener('change', () => {
            ...
            const availableMorals = selectedTheme ? 
                Object.keys(storyTemplates[selectedTheme]?.themes || {}) : [];
